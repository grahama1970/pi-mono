...
import type { PollerConfigBlock } from "./poller/setup.js";
...
export class SettingsManager {
	...
	getPollerSettings(): PollerConfigBlock | undefined {
		return this.settings.poller;
	}

	setPollerSettings(poller: PollerConfigBlock): void {

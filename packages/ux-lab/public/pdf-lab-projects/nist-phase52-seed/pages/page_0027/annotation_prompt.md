...
Agent-selected families: tables, footnotes_references, controls_requirements

## Candidate-selection signals

- table caption/grid signals: captions=29, drawings=735
- footnote/reference signals: footnotes=0, references=1
- control/requirement signals: control_ids=71, keywords=1

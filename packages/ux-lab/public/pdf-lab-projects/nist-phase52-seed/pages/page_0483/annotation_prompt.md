...
- section-like headings in first 20 lines: 7
- table caption/grid signals: captions=0, drawings=897
- footnote/reference signals: footnotes=0, references=1
- control/requirement signals: control_ids=64, keywords=4
- appendix/control summary table signal
- math/equation-like textual signals: 21
